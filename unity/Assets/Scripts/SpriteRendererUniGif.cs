...
/// </summary>
public class SpriteRendererUniGif : MonoBehaviour
{
    /// <summary>
    ...
    // Target row image
    public SpriteRenderer m_rawImage;
    ...
    private void Update()
    {
        switch (nowState)
        {
            ...
            case State.Playing:
                ...
                m_rawImage.sprite = ConvertToSprite(m_gifTextureList[m_gifTextureIndex].m_texture2d);
    ...
    {
        return Sprite.Create(texture, new Rect(0, 0, texture.width, texture.height), new Vector2(.5f, .5f), 512);
    }
    ...
    public void Play()
    {
        ...
        m_rawImage.sprite = ConvertToSprite(m_gifTextureList[0].m_texture2d);
